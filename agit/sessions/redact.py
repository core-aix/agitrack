...
Reuses the exact secret patterns aGiT already applies to commit messages
(:mod:`agit.commits.message`), so "what counts as a secret" has one definition,
...
from agit.commits.message import SECRET_ASSIGNMENT_RE, SECRET_MASK, SECRET_TOKEN_RES
