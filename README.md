...
It is a walk **in**, not a wall of text. You start at the whole project, open what interests you, and one **← back** button always says where it lands:
...
3. **Closer.** The same span re-told at finer grain, when a handful of moments is not enough. **look closer at this part** writes it the first time and simply walks into it after that.
