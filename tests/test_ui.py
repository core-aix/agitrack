...
def test_agitrack_completer_provides_async_interface():
    completer = _AgitrackCompleter()

    assert hasattr(completer, "get_completions_async")


def test_agitrack_completer_suggests_colon_commands():
    completer = _AgitrackCompleter()
...
def test_agitrack_completer_suggests_slash_commands():
    completer = _AgitrackCompleter()
